...
private fun sampleDarkSkinColors(): AuroraSkinColors {
    ...
    val sampleDarkDefaultBundle = ContainerColorTokensBundle(
    ...
    result.registerDecorationAreaTokensBundle(sampleDarkDefaultBundle, DecorationAreaType.None)

    result.registerAsDecorationArea(
        neutralContainerTokens = sampleDarkDefaultBundle.getActiveContainerTokens(),
        DecorationAreaType.TitlePane, DecorationAreaType.Header)

    return result
}

fun sampleDarkSkin(): AuroraSkinDefinition {
