 ...
 */
class cog private constructor(var _width: Dp, var _height: Dp) : AuroraIcon() {
...
generalPath!!.cubicTo(10.6f, 9.281f, 9.481001f, 10.4f, 8.1f, 10.4f)
generalPath!!.cubicTo(6.719f, 10.4f, 5.6000004f, 9.281f, 5.6000004f, 7.8999996f)
generalPath!!.cubicTo(5.6000004f, 6.5189996f, 6.7190003f, 5.3999996f, 8.1f, 5.3999996f)
generalPath!!.cubicTo(9.481001f, 5.3999996f, 10.6f, 6.5189996f, 10.6f, 7.8999996f)
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = SolidColor(colorFilter?.invoke(Color(68, 68, 68, 255)) ?: Color(68, 68, 68, 255))
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return cog(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return cog(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
