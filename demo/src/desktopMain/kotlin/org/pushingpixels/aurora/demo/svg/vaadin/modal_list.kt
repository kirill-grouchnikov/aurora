 ...
 */
class modal_list private constructor(var _width: Dp, var _height: Dp) : AuroraIcon() {
...
generalPath!!.close()
generalPath!!.moveTo(15.0f, 14.0f)
generalPath!!.lineTo(1.0f, 14.0f)
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return modal_list(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return modal_list(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
