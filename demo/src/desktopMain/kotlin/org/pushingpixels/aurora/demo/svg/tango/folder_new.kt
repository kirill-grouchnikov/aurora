 ...
 */
class folder_new private constructor(var _width: Dp, var _height: Dp) : AuroraIcon {
...
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = Brush.radialGradient(0.0f to (colorFilter?.invoke(Color(32, 32, 32, 255)) ?: Color(32, 32, 32, 255)), 1.0f to (colorFilter?.invoke(Color(185, 185, 185, 255)) ?: Color(185, 185, 185, 255)), center = Offset(-0.061180815f, -0.14211532f), radius = 0.061660703f, tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
...
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = Brush.radialGradient(0.0f to (colorFilter?.invoke(Color(255, 255, 255, 255)) ?: Color(255, 255, 255, 255)), 0.5f to (colorFilter?.invoke(Color(255, 245, 32, 227)) ?: Color(255, 245, 32, 227)), 1.0f to (colorFilter?.invoke(Color(255, 243, 0, 0)) ?: Color(255, 243, 0, 0)), center = Offset(55.0f, 125.0f), radius = 14.375f, tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
}
alpha = alphaStack.removeAt(0)
}
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return folder_new(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return folder_new(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
