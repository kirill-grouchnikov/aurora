...
brush = Brush.radialGradient(0.0f to Color(46, 52, 54, 255), 1.0f to Color(46, 52, 54, 0), center = Offset(0.0127570145f, 0.0018259275f), radius = 0.013016717f, tileMode = TileMode.Clamp)
...
shape = Outline.Generic(generalPath!!)
brush = Brush.linearGradient(0.0f to Color(114, 159, 207, 255), 1.0f to Color(52, 101, 164, 255), start = Offset(-0.6073853f, -0.42533743f), end = Offset(-0.48628375f, -0.5294353f), tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
}
alpha = alphaStack.removeAt(0)
alphaStack.add(0, alpha)
