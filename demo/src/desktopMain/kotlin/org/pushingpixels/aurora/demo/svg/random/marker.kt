 ...
 */
class marker private constructor(var _width: Dp, var _height: Dp) : AuroraIcon {
...
transform(
Matrix(values=floatArrayOf(
0.6000000238418579f, 0.0f, 0.0f, 0.0f,
...
withTransform({
   translate(left=87.0f, top=87.0f)
}) {
// _0_0_m2
withTransform({
transform(
...
withTransform({
   translate(left=26.5f, top=47.5f)
}) {
// _0_1_m1
withTransform({
transform(
...
withTransform({
   translate(left=40.5f, top=57.5f)
}) {
// _0_1_m2
withTransform({
transform(
...
withTransform({
   translate(left=54.5f, top=27.5f)
}) {
// _0_1_m3
withTransform({
transform(
...
withTransform({
   translate(left=68.5f, top=37.5f)
}) {
// _0_1_m4
withTransform({
transform(
...
withTransform({
   translate(left=82.5f, top=12.5f)
}) {
// _0_1_m5
withTransform({
transform(
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return marker(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return marker(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
