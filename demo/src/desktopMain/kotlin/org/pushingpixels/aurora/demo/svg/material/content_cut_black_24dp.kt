 ...
 */
class content_cut_black_24dp private constructor(var _width: Int, var _height: Int) : AuroraIcon {
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return content_cut_black_24dp(getOrigWidth().toInt(), getOrigHeight().toInt())
                }
            }
        }
