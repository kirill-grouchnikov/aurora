 ...
 */
class edit_copy private constructor(var _width: Int, var _height: Int) : AuroraIcon {
...
brush = Brush.linearGradient(0.0f to Color(240, 240, 239, 255), 0.59928656f to Color(232, 232, 232, 255), 0.82758623f to Color(255, 255, 255, 255), 1.0f to Color(216, 216, 211, 255), start = Offset(-0.08412492f, -0.06637067f), end = Offset(-0.07656078f, -0.07831126f), tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
...
// _0_0_0_2
brush = Brush.linearGradient(0.0f to Color(255, 255, 255, 255), 1.0f to Color(255, 255, 255, 0), start = Offset(-0.08361708f, -0.08558496f), end = Offset(-0.07337182f, -0.10000787f), tileMode = TileMode.Clamp)
...
brush = Brush.linearGradient(0.0f to Color(240, 240, 239, 255), 0.59928656f to Color(232, 232, 232, 255), 0.82758623f to Color(255, 255, 255, 255), 1.0f to Color(216, 216, 211, 255), start = Offset(0.13557555f, 0.1069905f), end = Offset(0.1202718f, 0.12305349f), tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
brush = SolidColor(Color(136, 138, 133, 255))
...
// _0_0_1_1
brush = Brush.linearGradient(0.0f to Color(255, 255, 255, 255), 1.0f to Color(255, 255, 255, 0), start = Offset(0.0983772f, 0.10077683f), end = Offset(0.08673385f, 0.11831974f), tileMode = TileMode.Clamp)
...
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = Brush.linearGradient(0.0f to Color(124, 124, 124, 255), 1.0f to Color(184, 184, 184, 255), start = Offset(0.09325789f, 0.10481685f), end = Offset(0.093310826f, 0.10469109f), tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
...
// _0_0_1_3
brush = Brush.linearGradient(0.0f to Color(255, 255, 255, 255), 1.0f to Color(255, 255, 255, 0), start = Offset(0.097690806f, 0.108003184f), end = Offset(0.09739848f, 0.108516015f), tileMode = TileMode.Clamp)
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return edit_copy(getOrigWidth().toInt(), getOrigHeight().toInt())
                }
            }
        }
