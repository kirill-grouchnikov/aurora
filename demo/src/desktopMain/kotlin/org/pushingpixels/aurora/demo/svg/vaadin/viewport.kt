 ...
 */
class viewport private constructor(var _width: Dp, var _height: Dp) : AuroraIcon {
...
generalPath!!.moveTo(4.0f, 15.0f)
generalPath!!.lineTo(4.0f, 16.0f)
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return viewport(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return viewport(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
