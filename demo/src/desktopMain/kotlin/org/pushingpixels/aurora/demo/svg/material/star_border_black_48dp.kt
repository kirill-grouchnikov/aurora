 ...
 */
class star_border_black_48dp private constructor(var _width: Dp, var _height: Dp) : AuroraIcon() {
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return star_border_black_48dp(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return star_border_black_48dp(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
