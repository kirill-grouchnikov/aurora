...
generalPath?.run {
    moveTo(15.7f, 5.3f)
    lineTo(14.7f, 4.3f)
    cubicTo(14.5f, 4.1000004f, 14.3f, 4.0f, 14.0f, 4.0f)
    lineTo(1.0f, 4.0f)
    cubicTo(0.39999998f, 4.0f, 0.0f, 4.4f, 0.0f, 5.0f)
    lineTo(0.0f, 10.0f)
    cubicTo(0.0f, 10.3f, 0.1f, 10.6f, 0.3f, 10.7f)
    lineTo(1.3f, 11.7f)
    cubicTo(1.5f, 11.9f, 1.6999999f, 12.0f, 2.0f, 12.0f)
    lineTo(15.0f, 12.0f)
    cubicTo(15.6f, 12.0f, 16.0f, 11.6f, 16.0f, 11.0f)
    lineTo(16.0f, 6.0f)
    cubicTo(16.0f, 5.7f, 15.9f, 5.5f, 15.7f, 5.3f)
    close()
    moveTo(14.0f, 10.0f)
    lineTo(1.0f, 10.0f)
    lineTo(1.0f, 5.0f)
