 ...
 */
class wifi_white_18dp private constructor(var _width: Int, var _height: Int) : AuroraIcon {
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return wifi_white_18dp(getOrigWidth().toInt(), getOrigHeight().toInt())
                }
            }
        }
