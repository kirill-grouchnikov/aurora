 ...
 */
class remove_circle_outline_24px private constructor(var _width: Int, var _height: Int) : AuroraIcon {
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return remove_circle_outline_24px(
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return remove_circle_outline_24px(getOrigWidth().toInt(), getOrigHeight().toInt())
                }
            }
        }
