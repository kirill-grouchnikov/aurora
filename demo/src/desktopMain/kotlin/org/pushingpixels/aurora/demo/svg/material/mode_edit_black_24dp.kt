 ...
 */
class mode_edit_black_24dp : Painter() {
...
generalPath?.run {
    ...
    lineTo(6.75f, 21.0f)
    lineTo(17.81f, 9.94f)
    lineTo(14.059999f, 6.1899996f)
    lineTo(3.0f, 17.25f)
    close()
    moveTo(20.71f, 7.04f)
    cubicTo(21.099998f, 6.65f, 21.099998f, 6.02f, 20.71f, 5.63f)
    lineTo(18.369999f, 3.2900002f)
    cubicTo(17.98f, 2.9f, 17.349998f, 2.9f, 16.96f, 3.2900002f)
    lineTo(15.129999f, 5.1200004f)
    lineTo(18.88f, 8.870001f)
    lineTo(20.71f, 7.040001f)
    close()
}
