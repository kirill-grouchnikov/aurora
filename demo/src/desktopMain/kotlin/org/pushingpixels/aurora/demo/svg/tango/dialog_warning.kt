...
// _0_0_0_1_2
brush = Brush.linearGradient(0.0f to Color(255, 255, 255, 255), 1.0f to Color(255, 255, 255, 87), start = Offset(0.14450783f, 0.5320508f), end = Offset(0.2380623f, 0.3873283f), tileMode = TileMode.Clamp)
