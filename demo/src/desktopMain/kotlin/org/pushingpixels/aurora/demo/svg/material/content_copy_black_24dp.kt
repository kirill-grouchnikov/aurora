 ...
 */
class content_copy_black_24dp private constructor(var _width: Int, var _height: Int) : AuroraIcon {
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return content_copy_black_24dp(
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return content_copy_black_24dp(getOrigWidth().toInt(), getOrigHeight().toInt())
                }
            }
        }
