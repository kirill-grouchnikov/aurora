...
fun main() = auroraApplication {
    AuroraWindow(
        ...
        FormLayout(
            ...
            LabelProjection(
                contentModel = LabelContentModel(text = stringResource(Res.string.contact)),
            ...
            Separator(
                ...
                label = stringResource(Res.string.propeller)
            )

            LabelProjection(
                contentModel = LabelContentModel(text = stringResource(Res.string.powerTakeIn)),
            ...
            LabelProjection(
                contentModel = LabelContentModel(text = stringResource(Res.string.power)),
            ...
            LabelProjection(
                contentModel = LabelContentModel(text = stringResource(Res.string.radius)),
            ...
            LabelProjection(
                contentModel = LabelContentModel(text = stringResource(Res.string.diameter)),
            ...
            ButtonBar(modifier = Modifier.xyw(1, 13, 7))
        }
    }
}
...
private fun AuroraLocaleScope.ButtonBar(modifier: Modifier) {
    ButtonBar(modifier, Paddings.Empty) {
        ...
        relatedGap()
        button(
            text = stringResource(Res.string.turnOff),
