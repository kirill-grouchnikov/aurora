 ...
 */
class format_text_underline private constructor() : AuroraIcon() {
...
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = Brush.linearGradient(0.0f to (colorFilter?.invoke(Color(73, 127, 198, 255)) ?: Color(73, 127, 198, 255)), 1.0f to (colorFilter?.invoke(Color(144, 179, 217, 255)) ?: Color(144, 179, 217, 255)), start = Offset(29.033241f, 35.44521f), end = Offset(14.33379f, 8.459655f), tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
brush = Brush.linearGradient(0.0f to (colorFilter?.invoke(Color(42, 83, 135, 255)) ?: Color(42, 83, 135, 255)), 1.0f to (colorFilter?.invoke(Color(52, 101, 164, 255)) ?: Color(52, 101, 164, 255)), start = Offset(22.125f, 36.96281f), end = Offset(22.125f, 8.25f), tileMode = TileMode.Clamp)
...
// _0_1_1
brush = Brush.linearGradient(0.0f to (colorFilter?.invoke(Color(255, 255, 255, 255)) ?: Color(255, 255, 255, 255)), 1.0f to (colorFilter?.invoke(Color(179, 179, 179, 0)) ?: Color(179, 179, 179, 0)), start = Offset(19.891792f, 15.114628f), end = Offset(21.506844f, 84.69681f), tileMode = TileMode.Clamp)
stroke = Stroke(width=1.0f, cap=StrokeCap.Butt, join=StrokeJoin.Miter, miter=4.0f)
if (generalPath == null) {
   generalPath = Path()
} else {
...
// _0_1_2
brush = Brush.linearGradient(0.0f to (colorFilter?.invoke(Color(255, 255, 255, 255)) ?: Color(255, 255, 255, 255)), 1.0f to (colorFilter?.invoke(Color(255, 255, 255, 0)) ?: Color(255, 255, 255, 0)), start = Offset(23.911612f, 21.13604f), end = Offset(23.911612f, 5.402913f), tileMode = TileMode.Clamp)
stroke = Stroke(width=1.0f, cap=StrokeCap.Butt, join=StrokeJoin.Miter, miter=4.0f)
if (generalPath == null) {
   generalPath = Path()
} else {
...
brush = Brush.linearGradient(0.0f to (colorFilter?.invoke(Color(73, 127, 198, 255)) ?: Color(73, 127, 198, 255)), 1.0f to (colorFilter?.invoke(Color(144, 179, 217, 255)) ?: Color(144, 179, 217, 255)), start = Offset(27.675018f, 43.398964f), end = Offset(16.0744f, 25.920008f), tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
brush = Brush.linearGradient(0.0f to (colorFilter?.invoke(Color(42, 83, 135, 255)) ?: Color(42, 83, 135, 255)), 1.0f to (colorFilter?.invoke(Color(52, 101, 164, 255)) ?: Color(52, 101, 164, 255)), start = Offset(5.0271654f, 48.7619f), end = Offset(5.0271654f, 41.416153f), tileMode = TileMode.Clamp)
...
// _0_1_4
brush = Brush.linearGradient(0.0f to (colorFilter?.invoke(Color(255, 255, 255, 255)) ?: Color(255, 255, 255, 255)), 1.0f to (colorFilter?.invoke(Color(255, 255, 255, 0)) ?: Color(255, 255, 255, 0)), start = Offset(39.421204f, 42.459263f), end = Offset(-24.130018f, 42.5f), tileMode = TileMode.Clamp)
