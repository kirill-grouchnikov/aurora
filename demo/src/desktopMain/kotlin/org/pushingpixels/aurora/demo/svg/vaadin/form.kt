 ...
 */
class form private constructor(var _width: Dp, var _height: Dp) : AuroraIcon {
...
generalPath!!.close()
generalPath!!.moveTo(16.0f, 11.0f)
...
generalPath!!.moveTo(0.0f, 11.0f)
generalPath!!.lineTo(4.0f, 11.0f)
generalPath!!.lineTo(4.0f, 15.0f)
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return form(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return form(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
