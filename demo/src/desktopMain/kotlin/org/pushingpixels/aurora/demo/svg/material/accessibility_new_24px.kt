 ...
 */
class accessibility_new_24px private constructor(var _width: Dp, var _height: Dp) : AuroraIcon() {
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return accessibility_new_24px(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return accessibility_new_24px(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
