 ...
 */
class bar_chart private constructor(var _width: Dp, var _height: Dp) : AuroraIcon() {
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return bar_chart(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return bar_chart(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
