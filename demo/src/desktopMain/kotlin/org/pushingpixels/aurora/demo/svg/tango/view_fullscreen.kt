 ...
 */
class view_fullscreen private constructor(var _width: Int, var _height: Int) : AuroraIcon {
...
brush = Brush.linearGradient(0.0f to Color(227, 237, 237, 255), 1.0f to Color(245, 245, 245, 255), start = Offset(-5.899574f, -2.0103426f), end = Offset(-1.0777539f, -1.929239f), tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
...
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = Brush.linearGradient(0.0f to Color(32, 74, 135, 255), 1.0f to Color(32, 74, 135, 0), start = Offset(-0.020374533f, 0.018776638f), end = Offset(-0.02038534f, 0.01966336f), tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
}
alpha = alphaStack.removeAt(0)
alphaStack.add(0, alpha)
...
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = Brush.linearGradient(0.0f to Color(32, 74, 135, 255), 1.0f to Color(32, 74, 135, 0), start = Offset(0.023028923f, -0.021222856f), end = Offset(0.022016527f, -0.021236775f), tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
}
alpha = alphaStack.removeAt(0)
alphaStack.add(0, alpha)
...
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = Brush.linearGradient(0.0f to Color(32, 74, 135, 255), 1.0f to Color(32, 74, 135, 0), start = Offset(-0.0108197415f, -0.009971192f), end = Offset(-0.01059093f, -0.010215834f), tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
}
alpha = alphaStack.removeAt(0)
}
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return view_fullscreen(getOrigWidth().toInt(), getOrigHeight().toInt())
                }
            }
        }
