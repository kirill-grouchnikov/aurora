 ...
 */
class table private constructor(var _width: Dp, var _height: Dp) : AuroraIcon {
...
generalPath!!.close()
generalPath!!.moveTo(15.0f, 12.0f)
...
generalPath!!.close()
generalPath!!.moveTo(15.0f, 6.0f)
generalPath!!.lineTo(11.0f, 6.0f)
generalPath!!.lineTo(11.0f, 4.0f)
generalPath!!.lineTo(15.0f, 4.0f)
generalPath!!.lineTo(15.0f, 6.0f)
generalPath!!.close()
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return table(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return table(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
