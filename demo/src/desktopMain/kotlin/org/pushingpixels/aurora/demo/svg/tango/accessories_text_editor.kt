 ...
 */
class accessories_text_editor private constructor(var _width: Int, var _height: Int) : AuroraIcon {
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return accessories_text_editor(getOrigWidth().toInt(), getOrigHeight().toInt())
                }
            }
        }
