 ...
 */
class browser private constructor(var _width: Dp, var _height: Dp) : AuroraIcon() {
...
generalPath!!.close()
generalPath!!.moveTo(3.0f, 1.0f)
generalPath!!.lineTo(12.0f, 1.0f)
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return browser(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return browser(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
