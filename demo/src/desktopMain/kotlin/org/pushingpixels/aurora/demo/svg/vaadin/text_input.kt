 ...
 */
class text_input private constructor(var _width: Dp, var _height: Dp) : AuroraIcon() {
...
generalPath!!.cubicTo(0.39999998f, 0.0f, 0.0f, 0.4f, 0.0f, 1.0f)
generalPath!!.lineTo(0.0f, 15.0f)
generalPath!!.cubicTo(0.0f, 15.6f, 0.4f, 16.0f, 1.0f, 16.0f)
...
alpha = alphaStack.removeAt(0)
    ...
    companion object {
        ...
        fun of(width: Dp, height: Dp): AuroraIcon {
            return text_input(_width = width, _height = height)
        }
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return text_input(getOrigWidth().dp, getOrigHeight().dp)
                }
            }
        }
