 ...
 */
class format_justify_left private constructor(var _width: Int, var _height: Int) : AuroraIcon {
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return format_justify_left(getOrigWidth().toInt(), getOrigHeight().toInt())
                }
            }
        }
