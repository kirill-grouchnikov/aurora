 ...
 */
class dialog_information private constructor(var _width: Int, var _height: Int) : AuroraIcon {
        ...
        fun factory(): AuroraIcon.Factory {
            return object : AuroraIcon.Factory {
                override fun createNewIcon(): AuroraIcon {
                    return dialog_information(getOrigWidth().toInt(), getOrigHeight().toInt())
                }
            }
        }
