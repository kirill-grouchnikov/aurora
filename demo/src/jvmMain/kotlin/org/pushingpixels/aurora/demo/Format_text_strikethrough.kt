...
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = LinearGradient(0.0f to Color(73, 127, 198, 255), 1.0f to Color(144, 179, 217, 255), startX = 29.033241f, startY = 37.44521f, endX = 14.33379f, endY = 10.459655f, tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
brush = LinearGradient(0.0f to Color(42, 83, 135, 255), 1.0f to Color(52, 101, 164, 255), startX = 22.125f, startY = 38.96281f, endX = 22.125f, endY = 10.25f, tileMode = TileMode.Clamp)
...
// _0_1_1
brush = LinearGradient(0.0f to Color(255, 255, 255, 255), 1.0f to Color(179, 179, 179, 0), startX = 19.891792f, startY = 17.114628f, endX = 21.506844f, endY = 86.69681f, tileMode = TileMode.Clamp)
stroke = Stroke(width=1.0f, cap=StrokeCap.Butt, join=StrokeJoin.Miter, miter=4.0f)
if (generalPath == null) {
   generalPath = Path()
} else {
...
// _0_1_2
brush = LinearGradient(0.0f to Color(255, 255, 255, 255), 1.0f to Color(255, 255, 255, 0), startX = 23.911612f, startY = 23.13604f, endX = 23.911612f, endY = 7.402913f, tileMode = TileMode.Clamp)
stroke = Stroke(width=1.0f, cap=StrokeCap.Butt, join=StrokeJoin.Miter, miter=4.0f)
if (generalPath == null) {
   generalPath = Path()
} else {
...
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = LinearGradient(0.0f to Color(0, 0, 0, 255), 1.0f to Color(0, 0, 0, 0), startX = 16.841536f, startY = 24.0f, endX = 16.841536f, endY = 25.010555f, tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
}
alpha = alphaStack.removeAt(0)
alphaStack.add(0, alpha)
...
brush = LinearGradient(0.0f to Color(73, 127, 198, 255), 1.0f to Color(144, 179, 217, 255), startX = 27.675018f, startY = 22.398964f, endX = 16.0744f, endY = 4.9200077f, tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
brush = LinearGradient(0.0f to Color(42, 83, 135, 255), 1.0f to Color(52, 101, 164, 255), startX = 5.0271654f, startY = 27.761904f, endX = 5.0271654f, endY = 20.416153f, tileMode = TileMode.Clamp)
...
// _0_1_5
brush = LinearGradient(0.0f to Color(255, 255, 255, 255), 1.0f to Color(255, 255, 255, 0), startX = 39.421204f, startY = 21.459263f, endX = -24.130018f, endY = 21.5f, tileMode = TileMode.Clamp)
