...
*/
class star_half_black_48dp private constructor(var _width: Int, var _height: Int) : AuroraIcon {
...
return star_half_black_48dp(getOrigWidth().toInt(), getOrigHeight().toInt())
}
}
}
}
