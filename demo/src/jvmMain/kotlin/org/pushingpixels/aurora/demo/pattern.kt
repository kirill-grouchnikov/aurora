                                ...
                                tileY@ while (true) {
                                    translate(left = startX, top = startY) {
                                        ...
                                        brush = LinearGradient(
                                            0.05f to Color(255, 0, 0, 255),
                                            0.95f to Color(255, 165, 0, 255),
                                            startX = 0.0f,
                                            startY = 0.0f,
                                            endX = 0.0f,
                                            endY = 25.0f,
                                        ...
                                        alphaTile = alpha * 1.0f
                                        brush = LinearGradient(
                                            0.05f to Color(255, 255, 255, 128),
                                            0.95f to Color(0, 0, 255, 128),
                                            startX = 5.0f,
                                            startY = 5.0f,
                                            endX = 45.0f,
                                            endY = 5.0f,
                                        ...
                                        shapeTile = Outline.Generic(path = Path().also {
                                            it.addOval(
                                                oval = Rect(
                                                    left = 5.0f,
                                                    top = 5.0f,
