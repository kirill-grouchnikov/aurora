...
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = RadialGradient(0.0f to Color(115, 210, 22, 255), 1.0f to Color(78, 154, 6, 255), centerX = 23.514278f, centerY = 33.0438f, radius = 14.294449f, tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
...
generalPath!!.close()
shape = Outline.Generic(generalPath!!)
brush = RadialGradient(0.0f to Color(255, 255, 255, 255), 1.0f to Color(255, 255, 255, 0), centerX = 16.471697f, centerY = -1.1440964f, radius = 35.145233f, tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
}
alpha = alphaStack.removeAt(0)
alphaStack.add(0, alpha)
...
brush = RadialGradient(0.0f to Color(255, 255, 255, 255), 1.0f to Color(255, 255, 255, 0), centerX = 14.70393f, centerY = 12.821266f, radius = 35.145233f, tileMode = TileMode.Clamp)
drawOutline(outline = shape!!, style=Fill, brush=brush!!, alpha=alpha)
}
alpha = alphaStack.removeAt(0)
}
