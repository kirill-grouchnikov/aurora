...
data class RibbonBandGroup(
    ...
    val commandProjections: List<Pair<BaseCommandButtonProjection<BaseCommandMenuContentModel, BaseCommand<BaseCommandMenuContentModel>>, PresentationPriority>> = emptyList(),
