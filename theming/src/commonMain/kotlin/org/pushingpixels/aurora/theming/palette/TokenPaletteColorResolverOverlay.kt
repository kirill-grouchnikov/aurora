...
class TokenPaletteColorResolverOverlay(
    ...
    val onContainerLow: ((TokenPalette) -> Int)? = null,
    val onContainer: ((TokenPalette) -> Int)? = null,
    val onContainerHigh: ((TokenPalette) -> Int)? = null,
    val containerOutlineLow: ((TokenPalette) -> Int)? = null,
    val containerOutline: ((TokenPalette) -> Int)? = null,
    val containerOutlineHigh: ((TokenPalette) -> Int)? = null,
    val containerSurfaceEnabledAlpha: ((TokenPalette) -> Float)? = null,
    val onContainerEnabledAlpha: ((TokenPalette) -> Float)? = null,
    val containerOutlineEnabledAlpha: ((TokenPalette) -> Float)? = null,
