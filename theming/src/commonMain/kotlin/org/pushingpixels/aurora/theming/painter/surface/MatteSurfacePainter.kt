...
/**
 * Surface painter that draws visuals with matte appearance.
 *
 * @author Kirill Grouchnikov
 */
open class MatteSurfacePainter : FractionBasedSurfacePainter(
    ColorStop(fraction = 0.0f, colorQuery = {
        if (it.isDark) it.containerSurfaceHigh else it.containerSurfaceLow
    }),
    ColorStop(fraction = 0.25f, colorQuery = ContainerColorTokens::containerSurface),
